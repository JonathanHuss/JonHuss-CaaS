...
using JonHuss_CaaS.UserInterface.Models;
...
namespace JonHuss_CaaS.UserInterface.Controllers
{
    public class EditController : Controller
    {
        ...
        {
            DiagramViewModel model = GetDiagramModel(conversationID);
        ...
        private DiagramViewModel GetDiagramModel(int conversationID)
        {
